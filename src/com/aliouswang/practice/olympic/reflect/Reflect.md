...
我的电脑是mac0S 14，CPU i7，内存16g， 在new 1,000,000 个String对象并调用其toUpperCase方法的情况下，最终测试的结果如下

```
native code use time : 122ms
reflect code use time : 795ms
```
可以看到使用反射的代码比正常编写的代码慢了6倍，虽然差距还是有的，但是这相差的673ms的时间差平摊到每一次的循环中，那这点差距就显得微不足道了，
所以对性能不是特别敏感的场景，使用反射性能是OK的。

以上！！各位看官，如果我的总结对你有一点点帮助，点个赞呗！！！-。-
